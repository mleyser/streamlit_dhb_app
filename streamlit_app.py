...
col1.markdown('Streamlit is **_really_ cool**.')
col1.text("Siege | Unentschiedens | Niederlagen: 21 | 4 | 4")
col1.text("Tore: 858")
col1.text("Gegentore: 753")
col1.text("Differenz: 105")
col1.text("Bester 7m-Schütze: Hans Lindberg(108/118/91.5%)")
col1.text("Sünder: Mijajlo Marsenic (57)")
col1.text("Zuschauerschnitt: 51972")
